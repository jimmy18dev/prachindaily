...
<meta property="og:image" 			content="<?php echo $meta['domain'];?>/image/site/partner.jpg"/>
...
<div class="article">
	<header class="article-header">
		<h1>ร่วมสร้างธุรกิจของคุณบนโลกออนไลน์กับปราจีนเดลี่</h1>
		<p><i class="fa fa-diamond"></i> เราจะช่วยสร้างความน่าเชื่อถือให้กับธุรกิจคุณ</p>
	</header>

	<figure class="article-cover">
		<img src="image/site/partner.jpg" alt="">
	...
	<div class="article-content">
			...
			<p>1. สร้างบัญชีของคุณบนเว็บปราจีนเดลี่ โดยคลิกที่ <strong>เข้าสู่ระบบ</strong> และ <strong>เข้าระบบด้วย Facebook</strong> จากนั้นระบบจะขอ Email ของคุณ หลังจากนั้นคุณจะได้บัญชีบนปราจีนเดลี่แล้ว</p>
			<p>2. คลิกที่ <strong>เพิ่มธุรกิจของคุณ</strong> จากนั้นใส่รายละเอียดของธุรกิจคุณ ตามช่องที่กำหนดไว้ให้ แนะนำว่าควรใช้คำที่เข้าใจง่ายและควบถ้วน จากนั้นคลิกที่ บันทึก</p>
			...
			<p class="poster">ข้อมูลโดยคุณ <span class="poster-name">ทีมงานปราจีนเดลี่</span></p>
	</div>

	<div class="article-btn">
		<?php if(MEMBER_ONLINE){?>
		<a href="page-editor.php" target="_parent" class="btn"><i class="fa fa-plus"></i>เพิ่มธุรกิจของคุณ</a>
		<?php }else{?>
		<a href="partner.php" target="_parent" class="facebook-btn"><i class="fa fa-facebook"></i> เข้าระบบด้วย Facebook</a>
		<?php }?>
	</div>
</div>
